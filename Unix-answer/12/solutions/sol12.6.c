 ...
 **
 **
 *   A version of webserv.c that considers any file in or below a
 *   directory called "cgi-bin" to be an executable program.
 */
 ...
 *
 *      build: cc sol12.6.c socklib.c -o sol12.6
 */
#include	<stdio.h>
#include	<stdlib.h>
#include	<unistd.h>
...
/*
 * look for /cgi-bin/ in path
 */
int in_cgibin(char *f)
{
